import children from '#lib/core/components/utils/children';
...
import transform from '#lib/core/components/utils/transform'; // eslint-disable-line import/no-named-as-default

/** The Component utils that are exposed as the static util property. */
// eslint-disable-next-line import/no-default-export
export default { children, extract, toDataURL, transform } as const;
